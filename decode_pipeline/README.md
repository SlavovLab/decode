...
Additional scripts for quantifying the non-modified peptides, proteins, and modified proteins from the MaxQuant search data are provided in [python_scripts/downstream_processing](https://github.com/SlavovLab/decode/tree/main/decode_pipeline/python_scripts/downstream_processing). The output from these scripts used in generating publication figures are also provided in [decode output](https://drive.google.com/open?id=15YoTBTZh4MdtAqHbibkYieEqyLyFi5hb&usp=drive_fs)

Other external analyses, such as mapping substitutions to structural domains with InterProScan and blasting all sample-specific protein sequences were also run. Scripts used to compile the output from those analyses are provided in [python_scripts/downstream_processing/scripts_for_processing_external_analyses](https://github.com/SlavovLab/decode/tree/main/decode_pipeline/python_scripts/downstream_processing/scripts_for_processing_external_analyses). The output from these scripts used in generating publication figures are also provided in [decode output](https://drive.google.com/open?id=15YoTBTZh4MdtAqHbibkYieEqyLyFi5hb&usp=drive_fs)
