...
[Supplemental Data 5](https://docs.google.com/spreadsheets/d/1vrVpevuzpacA73gyqZkBJSudse0z0Nv8/edit?usp=sharing&ouid=109814487119977139380&rtpof=true&sd=true): Table of SAAP-BP pairs identified in SILAC-labeled liver cells\citep{Savitski2018turnover} containing one row per unique SAAP-BP pair per sample. Precursor ion level abundances of the light and heavy peptides in each sample are listed, along with their sums, ratios and RAAS values. The first tab of the file provides a description of the columns in the data table. 
...
[Supplemental Data 7](https://drive.google.com/file/d/1XaiRGnfoTpMACKSmBPaFomcZ0lZOifbx/view?usp=sharing): Mapping of the amino acid substitution sites of unique pairs of BP/SAAP to proteins, their transcripts and genome coordinates, as defined in the Ensembl genome release \texttt{GRCh38.110}.
