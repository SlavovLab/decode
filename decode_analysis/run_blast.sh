...
## generated by ../genome_annotation/setup.sh AND unzip in $DECODE/
...
echo "collecting BP protein, transcript and genome coordinates" \
     ...
     "if data setup in ../genome_annotation/setup.sh is not present."
